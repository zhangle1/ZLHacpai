class UserArticlesEntity {
  ...
  UserArticlesEntity({this.sc, this.msg, this.random, this.data});

  UserArticlesEntity.fromJson(Map<String, dynamic> json) {
    sc = json['sc'];
    msg = json['msg'];
    random = json['random'];
...
class Data {
  ...
  Data({this.pagination, this.articles});
...
class Articles {
  ...
  Articles.fromJson(Map<String, dynamic> json) {
    ...
    paginationRecordCount = json['paginationRecordCount'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['paginationRecordCount'] = this.paginationRecordCount;
