class MyFollowPeopleEntity {
  int sc;
  String msg;
  String random;
  Data data;

  MyFollowPeopleEntity({this.sc, this.msg, this.random, this.data});

  MyFollowPeopleEntity.fromJson(Map<String, dynamic> json) {
    sc = json['sc'];
    msg = json['msg'];
    random = json['random'];
...
class Data {
  ...
  Data({this.pagination, this.isFollowing, this.users});
