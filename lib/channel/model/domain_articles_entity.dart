class DomainArticlesEntity {
  Pagination pagination;
  Domain domain;
  List<Articles> articles;

  DomainArticlesEntity({this.pagination, this.domain, this.articles});

  DomainArticlesEntity.fromJson(Map<String, dynamic> json) {
...
class Domain {
  ...
  Domain(
      {this.domainTitle,
        ...
        this.domainTagCnt,
        this.domainViewCount});

  Domain.fromJson(Map<String, dynamic> json) {
    domainTitle = json['domainTitle'];
    domainIconPath = json['domainIconPath'];
    if (json['domainTags'] != null) {
      domainTags = new List<DomainTags>();
      json['domainTags'].forEach((v) {
        domainTags.add(new DomainTags.fromJson(v));
      });
    }
    oId = json['oId'];
    ...
    domainViewCount = json['domainViewCount'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.domainTags != null) {
      data['domainTags'] = this.domainTags.map((v) => v.toJson()).toList();
    }
    data['oId'] = this.oId;
    data['domainURI'] = this.domainURI;
    data['domainDescription'] = this.domainDescription;
    data['domainTagCnt'] = this.domainTagCnt;
    data['domainViewCount'] = this.domainViewCount;
    return data;
  }
}
...
class DomainTags {
  ...
  DomainTags.fromJson(Map<String, dynamic> json) {
